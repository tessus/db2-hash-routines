...
cl -Od /nologo /c /I %APRINC% /D WIN32 hash.c
link /libpath:%APRLIB% /subsystem:console /incremental:no /out:hash.dll /dll /def:hash.def hash.obj libapr-1.lib libaprutil-1.lib db2api.lib kernel32.lib user32.lib
